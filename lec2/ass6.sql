...
-- Truy vấn dữ liệu
-- Viết truy vấn để lấy danh sách tất cả khách hàng cùng với tổng số đơn hàng mà họ đã đặt.

-- Viết truy vấn để lấy thông tin về tất cả các chi tiết đơn hàng, bao gồm tên sản phẩm, số lượng, và tổng số tiền của mỗi đơn hàng, phân nhóm theo OrderID.
